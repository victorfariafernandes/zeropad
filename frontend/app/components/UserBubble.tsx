...
export function UserBubble() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-10 w-36 rounded-lg border border-black/10 dark:border-white/15 bg-white dark:bg-zinc-950 shadow-md overflow-hidden z-50">
          <button
